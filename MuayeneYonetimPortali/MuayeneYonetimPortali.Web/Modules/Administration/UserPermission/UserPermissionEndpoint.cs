using MyRepository = MuayeneYonetimPortali.Administration.Repositories.UserPermissionRepository;
using MyRow = MuayeneYonetimPortali.Administration.UserPermissionRow;
